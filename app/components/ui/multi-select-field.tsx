...
export function MultiSelectField({
  ...
  const displayElement = selectedOptions.length > 0 ? (
    <div className="flex flex-wrap gap-1">
      {selectedOptions.map(option => (
        <div
          key={option.value}
          className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium text-gray-700 truncate"
    ...
    <div className="text-gray-400 text-sm">Select options</div>
  );
