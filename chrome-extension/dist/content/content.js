...
function getTextContent(selector, parent = document) {
    ...
    if (element) {
        ...
        return ((_a = clone.textContent) === null || _a === void 0 ? void 0 : _a.trim()) || null;
    }
    return null;
}
function getAttribute(selector, attribute, parent = document) {
    var _a;
    const element = parent.querySelector(selector);
    return ((_a = element === null || element === void 0 ? void 0 : element.getAttribute(attribute)) === null || _a === void 0 ? void 0 : _a.trim()) || null;
}
...
function openModal(profileData) {
    ...
    modalIframe.onload = () => {
        if (modalIframe === null || modalIframe === void 0 ? void 0 : modalIframe.contentWindow) {
...
function handleModalMessage(event) {
    ...
    // }
    var _a, _b;
    if (((_a = event.data) === null || _a === void 0 ? void 0 : _a.type) === 'NETWORK_BRAIN_CLOSE_MODAL') {
        console.log("Received close request from modal.");
        closeModal();
    }
    if (((_b = event.data) === null || _b === void 0 ? void 0 : _b.type) === 'NETWORK_BRAIN_SUBMIT') {
        ...
        chrome.runtime.sendMessage({ action: "submitProfile", payload: event.data.payload }, (response) => {
            if (chrome.runtime.lastError) {
                ...
                alert(`Network Brain Error: Failed to submit data. ${(response === null || response === void 0 ? void 0 : response.error) || 'Unknown error.'}`);
                // Keep modal open?
            }
        });
    }
...
const observer = new MutationObserver((mutationsList) => {
    if (document.getElementById('network-brain-add-button'))
        return;
