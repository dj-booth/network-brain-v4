...
function fetchJwt(googleToken) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield fetch(AUTH_API_URL, {
                method: 'POST',
                mode: 'cors',
                credentials: 'include',
                headers: {
...
function storeJwt(jwt) {
    return __awaiter(this, void 0, void 0, function* () {
        yield chrome.storage.local.set({ [JWT_STORAGE_KEY]: jwt });
...
function getStoredJwt() {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield chrome.storage.local.get([JWT_STORAGE_KEY]);
...
function authenticateAndGetJwt(interactive) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const resultUrl = yield new Promise((resolve, reject) => {
                chrome.identity.launchWebAuthFlow({ url: authUrl, interactive }, (responseUrl) => {
                    var _a;
                    if (chrome.runtime.lastError || !responseUrl) {
                        reject(new Error(((_a = chrome.runtime.lastError) === null || _a === void 0 ? void 0 : _a.message) || "Authentication flow failed or was cancelled."));
                    }
                    else {
                        resolve(responseUrl);
                    }
            ...
            const jwt = yield fetchJwt(googleIdToken);
            ...
            if (jwt) {
                ...
                yield clearJwt(); // Clear any old JWT if fetch failed
                return null;
            }
        }
        catch (error) {
            console.error("Authentication process failed:", error);
            yield clearJwt(); // Ensure no partial/invalid state
            return null;
        }
    });
}
    ...
    if (request.action === "submitProfileContext") {
        ...
        (() => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                const response = yield fetch(INGEST_API_URL, {
                    method: 'POST',
                    mode: 'cors',
                    credentials: 'include',
                    headers: {
...
function handleTranscribeAudio(audioBlob) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const jwt = yield getStoredJwt();
            if (!jwt) {
            ...
            const response = yield fetch(TRANSCRIBE_API_URL, {
                method: 'POST',
                mode: 'cors',
                credentials: 'include',
                headers: {
